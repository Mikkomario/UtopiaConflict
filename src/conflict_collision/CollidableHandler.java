...
{	
	...
	private class CollisionCheckOperator extends HandlingOperator
	{
		...
		protected boolean handleObject(Handled h)
		{	
			CollidableOld c = (CollidableOld) h;
		...
		public ArrayList<CollidableOld> getCollidedObjects()
		{

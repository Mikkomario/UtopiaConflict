 ...
 * @since 18.6.2013.
 */
public class CollisionHandlerOld extends LogicalHandler implements Actor
{
	// ATTRIBUTES	-----------------------------------------------------
	 ...
	 */
	public CollisionHandlerOld(boolean autodeath, ActorHandler superhandler)
	{
	...
	{
		return CollisionListenerOld.class;
	}
	
	@Override
	protected boolean handleObject(Handled h)
	{
		CollisionListenerOld listener = (CollisionListenerOld) h;
	 ...
	 */
	public void addCollisionListener(CollisionListenerOld c)
	{
		super.addHandled(c);
	}
